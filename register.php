...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="images/icon.png">ESCANOR Tutorials <br>Ocean of Knowledge
      <br>LIVE AND LET LIVE
      <p class="subtitle">WELCOME TO ESCANOR TUTORIALS...</p> 
  </div>
</section> 
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff;">
              <p align="left">&copy; ESCONAR TUTORIALS</p>
     </footer>
 </section>
